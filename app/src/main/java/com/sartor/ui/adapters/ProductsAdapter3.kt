...
class ProductsAdapter3(private var list: List<Product>, private val context: Context) :
    RecyclerView.Adapter<ProductsAdapter3.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.img.setOnClickListener {
            Navigation.findNavController(context as Activity, R.id.homeHost).navigate(
                R.id.action_searchProductsFragment_to_yourShoppingBagFragment
            )
        }
        /* holder.img.setOnClickListener {
            Navigation.findNavController(context as Activity, R.id.homeHost).navigate(
   ...
   /*     holder.container.setOnClickListener {
            Navigation.findNavController(context as Activity, R.id.homeHost).navigate(
                R.id.action_searchProductFragment_to_sellerProfileFragment
            )
        }
*/
